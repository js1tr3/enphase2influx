...
parser.add_argument(
    "--url",
    default="http://envoy.local/production.json",
    help="the URL of production.json (default: http://envoy.local/production.json)",
)
...
# Query the url
try:
    #response = urllib3.urlopen(__url__)
    http = urllib3.PoolManager()
    r = http.request('GET', __url__)
    r.status
    r.data
